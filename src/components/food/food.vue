...
<!--(单个)食品详情过渡效果-->
  <transition name="move">
    <!--
      (单个)食品详情
      v-show="showFlag" class="food" ref="food"
      showFlag:默认关闭食品详情页面状态
      ...
      <div class="food-content">
        ...
        <div class="content">
          ...
          <!--
                ...
                传递属性food(属性值为food,food是从父组件goods被点击的那个商品(单个的).
          -->
          ...
          <transition name="fade">
            <!--d
              ...
              !food.count是在food.不存在count这个属性时,
              food.count===0,从1减到0
            -->
...
<script>
  ...
  export default {
    props: {
      // 接收从父组件穿过来的food,也是在父组件你goods中被点击的那个食品.此时food.count,即是该食品的数量.
      food: {
        type: Object
      }
    },
